...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-zinc-100 text-zinc-950">
        <div
            x-data="{ sidebarOpen: false, usersOpen: {{ (request()->routeIs('admin.customer*') || request()->routeIs('admin.customers*')) ? 'true' : 'false' }}, orderOpen: {{ request()->routeIs('admin.orders*') ? 'true' : 'false' }}, inventoryOpen: {{ request()->routeIs('admin.products*') || request()->routeIs('admin.restock*') || request()->routeIs('admin.purchases*') || request()->routeIs('admin.product.movement*') || request()->routeIs('admin.product.summary*') ? 'true' : 'false' }}, expensesOpen: {{ request()->routeIs('admin.expenses*') ? 'true' : 'false' }} }"
